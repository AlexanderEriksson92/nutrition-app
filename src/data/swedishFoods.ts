...
export const SWEDISH_FOODS: SwedishFood[] = [
  ...
  { name: "Sötpotatis", calories: 86, protein: 1.6, fat: 0.1, carbs: 20.0, fiber: 3.0, omega3: 0.01, vitaminA: 700, vitaminC: 2.4, vitaminD: 0, vitaminE: 0.3, vitaminK: 1.8, b1: 0.08, b2: 0.06, b3: 0.6, b5: 0.8, b6: 0.2, b7: 4.0, b12: 0, folate: 11, iron: 0.6, calcium: 30, iodine: 1, magnesium: 25, zinc: 0.3, potassium: 337, selenium: 0.6, copper: 0.15, manganese: 0.3, defaultAmount: 200 },
  ...
  { name: "Spenat (färsk)", calories: 23, protein: 2.9, fat: 0.4, carbs: 0.6, fiber: 2.2, omega3: 0.14, vitaminA: 470, vitaminC: 28, vitaminD: 0, vitaminE: 2.0, vitaminK: 483, b1: 0.08, b2: 0.19, b3: 0.7, b5: 0.06, b6: 0.2, b7: 0.1, b12: 0, folate: 194, iron: 2.7, calcium: 99, iodine: 1, magnesium: 79, zinc: 0.5, potassium: 558, selenium: 1.0, copper: 0.13, manganese: 0.9, defaultAmount: 65 },
  { name: "Avocado", calories: 160, protein: 2.0, fat: 14.7, carbs: 8.5, fiber: 6.7, omega3: 0.1, vitaminA: 7, vitaminC: 10, vitaminD: 0, vitaminE: 2.1, vitaminK: 21.0, b1: 0.07, b2: 0.13, b3: 1.7, b5: 1.4, b6: 0.3, b7: 5.0, b12: 0, folate: 81, iron: 0.6, calcium: 12, iodine: 1, magnesium: 29, zinc: 0.6, potassium: 485, selenium: 0.4, copper: 0.19, manganese: 0.14, defaultAmount: 150 },

  // --- MEJERIPRODUKTER ---
  { name: "Fetaost", calories: 260, protein: 14.0, fat: 21.0, carbs: 1.0, fiber: 0, omega3: 0.1, vitaminA: 125, vitaminC: 0, vitaminD: 0.4, vitaminE: 0.2, vitaminK: 1.5, b1: 0.04, b2: 0.2, b3: 0.4, b5: 0.5, b6: 0.1, b7: 1.5, b12: 1.0, folate: 32, iron: 0.7, calcium: 490, iodine: 35, magnesium: 19, zinc: 2.8, potassium: 62, selenium: 15, copper: 0.03, manganese: 0.03, defaultAmount: 150 },
  { name: "Grekisk Yoghurt 10%", calories: 130, protein: 6.0, fat: 10.0, carbs: 4.0, fiber: 0, omega3: 0.05, vitaminA: 70, vitaminC: 0, vitaminD: 0, vitaminE: 0.1, vitaminK: 0.5, b1: 0.03, b2: 0.2, b3: 0.1, b5: 0.4, b6: 0.04, b7: 2.0, b12: 0.5, folate: 12, iron: 0.1, calcium: 120, iodine: 30, magnesium: 11, zinc: 0.6, potassium: 150, selenium: 2.0, copper: 0.01, manganese: 0.01, defaultAmount: 200 },
];